...
我们仔细研究后，得出了几个改善方向：
1）复合时几种材料的张力匹配问题，这个一般稍微有点复合机操作知识的都会注意的；
2）控制材料平整度，材料越宽越会出现荡边问题，不管是什么材料；
3）复合前材料是不是存在极大内应力，任何材料只要有内应力存在，熟化后终归会体现出来的，这个问题恰恰是行业内基本都会是忽略的，而这个问题恰恰是导致成品包装膜卷曲最致命的原因。
